//
//  HLProfileTableViewController.swift
//  HLSinaWeibo
//
...
fileprivate let profileCellID = "HLProfileTableViewCell"


class HLProfileTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.textLabel?.text = String.init(format: "profile introduce,cell id = %d ", indexPath.row)
